...
(function () {
	...
	nameSpace.init = function () {
		...
		TweenMax.set(["#cta", "#code", "#line"], { autoAlpha: 0 });
		...
		// 	TweenMax.to("#cta", 0.1, { scale: 1.1, y: 0, transformOrigin: "70% 80%", rotationZ: 0.01, force3D: true, rotationZ: 0.01, transformPerspective: 400 });
		// };
	...
	nameSpace.initAnimation = function () {
		...
		timeline
			...
			.to("#copy-1", 0.4, { ransformPerspective: 400, autoAlpha: 0, force3D: true, rotationZ: 0.01, ease: Linear.easeNone}, "+=2.0")

		
			.to("#copy-2", 0.4, { transformPerspective: 400, autoAlpha: 1, force3D: true, rotationZ: 0.01, ease: Power2.easeIn }, "+=0.0")

			.to(["#copy-1", "#copy-2"], 0.4, { transformPerspective: 400, autoAlpha: 0, force3D: true, rotationZ: 0.01, ease: Power2.easeIn }, "+=3")

			.to(["#line", "#copy-3", "#copy-4"], 0.3, { transformPerspective: 400, autoAlpha: 1, force3D: true, rotationZ: 0.01, ease: Power2.easeIn }, "+=0.0")

			.to(["#copy-3"], 0.3, { transformPerspective: 400, autoAlpha: 0, force3D: true, rotationZ: 0.01, ease: Power2.easeIn }, "+=3.5")

			.to(["#copy-5"], 0.3, { transformPerspective: 400, autoAlpha: 1, force3D: true, rotationZ: 0.01, ease: Power2.easeIn }, "+=0.0")
			...
			.to(["#cta"], 0.3, { autoAlpha: 1, ease: Cubic.easeInOut }, "-=0.3");
	};
