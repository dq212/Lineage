...
(function () {
  ...
  nameSpace.init = function () {
    ...
    gsap.set(['#copy-1', '#cta'], { x: 0, y: 0, autoAlpha: 0 });
  ...
  nameSpace.initAnimation = function () {
    ...
    // gsap.set(logo, {x:50, y:50, opacity:0});
    ...
    timeline
      ...
      .fromTo(['#copy-1'],  {x:-10, y:10, autoAlpha:0}, {x:0, y:0, duration:0.4,
        transformPerspective: 400,
        autoAlpha: 1,
        force3D: true,
        rotationZ: 0.01,
        ...
        { duration:0.3, autoAlpha: 1, ease: Cubic.easeInOut },
        '+=0.1'
      );
